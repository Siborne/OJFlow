...
exports.LuoguAdapter = void 0;
const base_adapter_1 = require("./base-adapter");
class LuoguAdapter extends base_adapter_1.BaseAdapter {
    id = 'luogu';
    displayName = '\u6d1b\u8c37';
    contestUrl = 'https://www.luogu.com.cn/contest/list?page=1&_contentOnly=1';
    searchUrl = 'https://www.luogu.com.cn/api/user/search';
    constructor() {
        super({ timeoutMs: 12000 });
    }
    ...
    async fetchRating(handle) {
        ...
        const userPageRes = await this.http.get(`https://www.luogu.com.cn/user/${userId}`, { maxRedirects: 3, timeout: 8000 });
        const html = typeof userPageRes.data === 'string'
            ? userPageRes.data
