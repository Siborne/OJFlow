...
exports.LanqiaoAdapter = void 0;
const base_adapter_1 = require("./base-adapter");
class LanqiaoAdapter extends base_adapter_1.BaseAdapter {
    id = 'lanqiao';
    displayName = '\u84dd\u6865\u4e91\u8bfe';
    contestUrl = 'https://www.lanqiao.cn/api/v2/contests/?sort=opentime&paginate=0&status=not_finished&game_type_code=2';
